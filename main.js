...
// const number1 = 5
// const number2 = 2
// const otv = alert(ostatok: ${number1 % number2})
...
// Javob:Pasdan yozib keting kodini
// const randomniy = (Math.round(Math.random()*11))
// const otv = alert(randomniy)
...
// const num = 12.510;
// const otv = alert(Math.floor(num))
...
// console.log(harflar[0],harflar[1], harflar[2], harflar[19], harflar[10], harflar[10], harflar[13] , harflar[6])
...
// const ism = prompt("ismigizni kiriting");
// const naoborot = ism.split('').reverse().join('');
...
// const style = prompt("colori yozing");
// const sd = document.createElement("h1");
// const sds = document.createElement("h2");
// sds.textContent = yosh;
// sd.textContent = ism;
// sds.style.color = style;
// sd.style.color = style;
// document.body.appendChild(sd);
// document.body.appendChild(sds);
